...
def load_and_freeze_mlp(model_path):
    ...
    model = MLP(input_dim, original_output_dim, hidden_width, hidden_depth, dropout_rate)
...
def load_and_freeze_cnn(model_path):
    ...
    model = EfficientNetClassifier(original_num_classes, original_dropout_rate)
    model.load_state_dict(state_dict)
    model.to(device)
...
if __name__ == "__main__":
    ...
    MODEL_FILE = '/home/UG/n2402401d/SC4001_Project/FINAL/feature_level_fusion/best_feature_fusion_final.pth'
